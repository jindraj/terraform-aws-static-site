...
# prepared moved blocks if this is even possible
#moved {
#  from = gitlab_project_variable.s3_bucket[data.gitlab_project.this]
#  to   = gitlab_project_variable.extra["${data.gitlab_project.this}-AWS_S3_BUCKET${var.aws_env_vars_suffix}"]
#}
#gitlab_project_variable.aws_default_region
#gitlab_project_variable.cloudfront_distribution_id
#gitlab_project_variable.site_aws_role_arn
#gitlab_project_variable.site_aws_access_key_id
#gitlab_project_variable.site_aws_secret_access_key
#gitlab_project_variable.extra
