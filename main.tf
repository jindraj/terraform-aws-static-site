...
module "cdn" {
  ...
  logging_config = var.logs_bucket_domain_name == null ? null : {
    bucket          = var.logs_bucket_domain_name # TODO: is this supposed to be the same bucket as logs_bucket? should we change the input to bucket_name and read the domain_name from data instead?
